...
``` r
result <- detect_lasso(small_lasso, segment_count = 2)
summary(result)
#> 
#> Call:
#> detect_lasso(data = small_lasso, segment_count = 2)
#> 
#> Change points:
#> 73 151 
#> 
...
``` r
result_vanilla_percentage <- detect_lasso(
  small_lasso, segment_count = 2, vanilla_percentage = 0.5
)
summary(result_vanilla_percentage)
#> 
#> Call:
#> detect_lasso(data = small_lasso, segment_count = 2, vanilla_percentage = 0.5)
#> 
#> Change points:
#> 74 150 
#> 
...
``` r
result_multiple_epochs <- detect_lasso(
  small_lasso,
  segment_count = 2,
...
#> 
#> Call:
#> detect_lasso(data = small_lasso, segment_count = 2, multiple_epochs = function(segment_length) {
