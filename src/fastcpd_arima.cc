...
Rcpp::List fastcpd_arima_impl(
  ...
  fastcpd::classes::Fastcpd<fastcpd::families::ArimaFamily, false, false, fastcpd::classes::CostAdjustment::kBIC, false, -1> fastcpd_class(
      beta, nullptr, nullptr, nullptr,
      nullptr, cp_only, data, epsilon, family, multiple_epochs_function_,
...
Rcpp::List fastcpd_arima_prog_impl(
    arma::mat const& data, double const beta,
    int const segment_count,
    double const trim, double const momentum_coef,
    Rcpp::Nullable<Rcpp::Function> const& multiple_epochs_function,
  ...
  fastcpd::classes::Fastcpd<fastcpd::families::ArimaFamily, true, false, fastcpd::classes::CostAdjustment::kBIC, false, -1> fastcpd_class(
      beta, nullptr, nullptr, nullptr,
      nullptr, cp_only, data, epsilon, family, multiple_epochs_function_,
      line_search, lower, momentum_coef, order, p, p_response, pruning_coef,
      segment_count, trim, upper, vanilla_percentage,
...
Rcpp::List fastcpd_arima_mbic_impl(
    arma::mat const& data, double const beta,
    int const segment_count,
    double const trim, double const momentum_coef,
    Rcpp::Nullable<Rcpp::Function> const& multiple_epochs_function,
  ...
  fastcpd::classes::Fastcpd<fastcpd::families::ArimaFamily, false, false, fastcpd::classes::CostAdjustment::kMBIC, false, -1> fastcpd_class(
      beta, nullptr, nullptr, nullptr,
      nullptr, cp_only, data, epsilon, family, multiple_epochs_function_,
      line_search, lower, momentum_coef, order, p, p_response, pruning_coef,
      segment_count, trim, upper, vanilla_percentage,
...
Rcpp::List fastcpd_arima_mbic_prog_impl(
    arma::mat const& data, double const beta,
    int const segment_count,
    double const trim, double const momentum_coef,
    Rcpp::Nullable<Rcpp::Function> const& multiple_epochs_function,
  ...
  fastcpd::classes::Fastcpd<fastcpd::families::ArimaFamily, true, false, fastcpd::classes::CostAdjustment::kMBIC, false, -1> fastcpd_class(
      beta, nullptr, nullptr, nullptr,
      nullptr, cp_only, data, epsilon, family, multiple_epochs_function_,
      line_search, lower, momentum_coef, order, p, p_response, pruning_coef,
      segment_count, trim, upper, vanilla_percentage,
...
Rcpp::List fastcpd_arima_mdl_impl(
    arma::mat const& data, double const beta,
    int const segment_count,
    double const trim, double const momentum_coef,
    Rcpp::Nullable<Rcpp::Function> const& multiple_epochs_function,
  ...
  fastcpd::classes::Fastcpd<fastcpd::families::ArimaFamily, false, false, fastcpd::classes::CostAdjustment::kMDL, false, -1> fastcpd_class(
      beta, nullptr, nullptr, nullptr,
      nullptr, cp_only, data, epsilon, family, multiple_epochs_function_,
      line_search, lower, momentum_coef, order, p, p_response, pruning_coef,
      segment_count, trim, upper, vanilla_percentage,
...
Rcpp::List fastcpd_arima_mdl_prog_impl(
    arma::mat const& data, double const beta,
    int const segment_count,
    double const trim, double const momentum_coef,
    Rcpp::Nullable<Rcpp::Function> const& multiple_epochs_function,
  ...
  fastcpd::classes::Fastcpd<fastcpd::families::ArimaFamily, true, false, fastcpd::classes::CostAdjustment::kMDL, false, -1> fastcpd_class(
      beta, nullptr, nullptr, nullptr,
      nullptr, cp_only, data, epsilon, family, multiple_epochs_function_,
      line_search, lower, momentum_coef, order, p, p_response, pruning_coef,
      segment_count, trim, upper, vanilla_percentage,
